...
% Will take millions of years. :( Need to replace with http://in.mathworks.com/matlabcentral/fileexchange/24616-kmeans-clustering

[idx,centroids] = kmeans(points, k_value); 
...
keySet = hash(valueSet,func,w,b);
% FUNCTION create_hash_keys END

function keySet = hash(valueSet,func,w,b)
